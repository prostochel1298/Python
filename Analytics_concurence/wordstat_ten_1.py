...
def wordstat():  
    ...
    phrases = [
        ...
        'Кангария', 
        'Скорфин', 
        'мкк Универсального финансирования',
        'Турбозайм',
        'Быстроденьги',
        'Кнопкаденьги',
        'Viva Деньги',
    ...
    try:
        ...
        if 'data' in report:
            ...
            mapping = {"Finbridge":['Новое финансирование','Кангария', 'Скорфин','мкк Универсального финансирования'],
               "Eqvanta":['Турбозайм','Быстроденьги','Кнопкаденьги'],
               "Viva-Деньги":['Viva Деньги','ЦФП','Займ Онлайн'] 
               }      
